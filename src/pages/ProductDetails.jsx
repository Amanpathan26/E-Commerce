    ...
    return (
        <>
            ...
            <div className="bg-white w-[80%] mx-auto my-5 border rounded-[6px] flex justify-start flex-wrap sm:flex-nowrap items-center py-5">
                ...
                <div className='min-w-[300px] w-[60%] mx-auto'>
                    ...
                    <div>
                        ...
                        <button className="bg-yellow-500 rounded px-4 py-1.5 border border-black text-bolder text-blue" onClick={() => { addToCart(idProduct.id, idProduct.title, idProduct.imgSrc, idProduct.discription, idProduct.price) }}>Add to cart</button>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <Product items={categoryProduct} addToCart={addToCart} />
            </div>
